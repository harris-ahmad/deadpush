...
1. Journal store (changed-file originals + hashes) — **in progress on `feat/journal-store`** (`deadpush/journal.py`)
2. Save points (create / list / restore; validation stub: “no quarantined secrets in tree”)
